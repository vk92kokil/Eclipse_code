 ...
 * @author Dave
 */
public class FacebookUserFilter extends Applet implements Filter {

        private static final Logger logger = LoggerFactory.getLogger(FacebookUserFilter.class);

        private String api_key;
        private String secret;
        private String ipAddress = LoggerConstants.getIpAddress();
        private String facebookUserId = LoggerConstants.getFacebookUserId();
        ...
        public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
                try {
                        ...
                        IFacebookRestClient userClient = getUserClient(session);
                        if(userClient == null) {
                        ...
                        FacebookWebappHelper facebook = new FacebookWebappHelper(request, response, api_key, secret, userClient);
